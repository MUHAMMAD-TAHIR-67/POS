...
import { Button, Col, Row, Typography, Select, Input, Table, Modal, Space } from 'antd';
import { useAuthContext } from 'contexts/AuthContext';
import { setDoc, doc, serverTimestamp, query, collection, getDocs, where, updateDoc, getDoc, orderBy } from 'firebase/firestore';
...
export default function AddBill() {
    ...
    const handleCalculateTotal = () => {
        ...
        Modal.confirm({
            ...
            onOk: () => {
                ...
                const finalAmount = total - calculatedPercentageAmount + previousBalance;
                setFinalAmountDue(finalAmount);
                setDifference(finalAmount - total); 

                window.toastify(`Percentage Amount: RS ${calculatedPercentageAmount}`, "success");
            },
        });
    };
    ...
    const handleAddBill = async () => {
        ...
        const totalAmountDue = finalBillAmount + previousBalanceAmount; 
    ...
    const handlePrint = () => {
        ...
        const invoiceDetailsHTML = `
          <div style="display: flex; justify-content: space-between; margin-top:-13%;">
            <div></div>
        ...
        const totalHTML = `
          <div style="margin-top: 30px; margin-left: 65%; text-align: right; width: 200px;">
            <p><strong>Total:</strong> ${totalSum || 0}</p>
            ...
            <p><strong>Previous:</strong> ${previousBalance ? previousBalance.toFixed(0) : 0}</p>
            <hr />
          ...
          <html>
            ...
            <body>
              <div style="height: 70px; margin-top: -15px;">               
                <img src="/4.jpg" alt="" style="width: 150px; height: 70px; margin-left: 40%" />
